...
#		CRAWL VARIALES
var PLAYER_CRAWL_SPEED = 200
var PLAYER_CRAWL_ACCELERATION = 0.75
var PLAYER_CRAWL_FRICTION = .9
...
var PLAYER_HEALTH_POINTS = 2

#		POWER (DE)ACTIVATION
var PLAYER_CAN_GLAIRE = false
var PLAYER_CAN_HOVER = false
var PLAYER_CAN_CRAWL = false # Buggy & Unexploited feature
